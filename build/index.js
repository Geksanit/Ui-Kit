...
/* harmony default export */ __webpack_exports__["a"] = (convertRemToPixels);
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__scripts_convertRemToPixels__ = __webpack_require__(1);
/* global $ */
...
class Slider {
  ...
  sliderChange() {
    const { $element } = this;
    const width = $element.width() - Object(__WEBPACK_IMPORTED_MODULE_0__scripts_convertRemToPixels__["a" /* default */])(1.25);
    const value = $element.val();
    const min = this.$element.prop('min');
    const max = this.$element.prop('max');
    const newLeft = ((width / (max - min)) * (value - min)) - Object(__WEBPACK_IMPORTED_MODULE_0__scripts_convertRemToPixels__["a" /* default */])(0.625);
    this.$view.text(value).css({ left: newLeft });
    const newWidth = ((width / (max - min)) * (value - min)) + Object(__WEBPACK_IMPORTED_MODULE_0__scripts_convertRemToPixels__["a" /* default */])(0.625);
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__scripts_autobind__ = __webpack_require__(8);
/* global $ */
...
/* harmony default export */ __webpack_exports__["a"] = (autobind);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__all_included__ = __webpack_require__(12);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__favicons_favicons__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_standart_button_standart_button__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_slider_slider__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_search_search__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_search_search___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__components_search_search__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_map_map__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_video_video__ = __webpack_require__(7);
...
const faviconsContext = __webpack_require__(14);
...
var map = {
	"./android-chrome-48x48.png": 15,
	"./apple-touch-icon.png": 16,
	"./browserconfig.xml": 17,
	"./favicon-16x16.png": 18,
	"./favicon-32x32.png": 19,
	"./favicon.ico": 20,
	"./manifest.json": 21,
	"./mstile-150x150.png": 22,
	"./safari-pinned-tab.svg": 23
};
